...
└── Camera capture (Tesseract) → raw text
          ↓
Processing Core
├── LLM (Ollama + qwen2.5-coder:3b)   → summarization / file navigation intent
...
├── src/netra/services/       # OCR/PDF/Braille/STT/TTS/Ollama/Store services
...
# Should return: {"models":[{"name":"qwen2.5-coder:3b",...}]}
```
